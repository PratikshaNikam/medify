    ...
    <header>
      <Box p={1} bgcolor="primary.main">
        <Typography fontSize={14} textAlign="center" color="#fff">
          The health and well-being of our patients and their health team will always be our priority, so we follow the best practices for cleanliness.
      ...
      <Container maxWidth="xl">
        ...
        py={2}>
          ...
          <Stack
            ...
            <Link to="/search">Hospital</Link>
            <Link>Medicines</Link>
            <Link>Surgeries</Link>
            <Link>Software for Provider</Link>
            <Link>Facilities</Link>
            <Link to="/mybookings">
              <Button variant="contained" disableElevation > My Bookings</Button></Link>
